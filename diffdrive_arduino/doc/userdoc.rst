...
3. Check if the hardware interface loaded properly, by opening another terminal and executing
   ...
   .. code-block:: shell
    ...
    command interfaces
          Joint_1/velocity [available] [claimed]
          Joint_2/velocity [available] [claimed]
    state interfaces
          Joint_1/position
          Joint_1/velocity
          Joint_2/position
...
5. If everything is fine, now you can send a command to *Diff Drive Controller* using ROS 2 CLI interface:
   ...
   .. code-block:: shell
    ...
    [DiffDriveArduinoHardware]: Got command 43.33333 for 'Joint_1'!
    [DiffDriveArduinoHardware]: Got command 50.00000 for 'Joint_2'!
